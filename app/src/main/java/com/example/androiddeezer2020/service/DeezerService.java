...
//    }
//
    public static void searchAlbum(String name, Response.Listener<DataAlbum> response, Response.ErrorListener errorListener, Context context){
        RequestQueue queue = Volley.newRequestQueue(context);
    ...
    public static void searchTrack(String name, Response.Listener<DataTrack> response, Response.ErrorListener errorListener, Context context){
        RequestQueue queue = Volley.newRequestQueue(context);
        System.out.println("id : " +name);
        String url ="https://api.deezer.com/album/"+ URLEncoder.encode(name);
